...
public class Tithi
{
    ...
    public string ToUnqualifiedString()
    {
        switch (value)
        {
            ...
            case Name.ShuklaPratipada:
                return "Prathama";
            case Name.KrishnaDvitiya:
            case Name.ShuklaDvitiya:
                return "Dvitiya";
            case Name.KrishnaTritiya:
            case Name.ShuklaTritiya:
                return "Tritiya";
            case Name.KrishnaChaturti:
            case Name.ShuklaChaturti:
                return "Chaturthi";
            case Name.KrishnaPanchami:
            case Name.ShuklaPanchami:
                return "Panchami";
            case Name.KrishnaShashti:
            case Name.ShuklaShashti:
                return "Shashti";
            case Name.KrishnaSaptami:
            case Name.ShuklaSaptami:
                return "Saptami";
            case Name.KrishnaAshtami:
            case Name.ShuklaAshtami:
                return "Ashtami";
            case Name.KrishnaNavami:
            case Name.ShuklaNavami:
                return "Navami";
            case Name.KrishnaDasami:
            case Name.ShuklaDasami:
                return "Dashami";
            case Name.KrishnaEkadasi:
            case Name.ShuklaEkadasi:
                return "Ekadashi";
            case Name.KrishnaDvadasi:
            case Name.ShuklaDvadasi:
                return "Dwadashi";
            case Name.KrishnaTrayodasi:
            case Name.ShuklaTrayodasi:
                return "Trayodashi";
            case Name.KrishnaChaturdasi:
            case Name.ShuklaChaturdasi:
                return "Chaturdashi";
    ...
    public NandaType toNandaType()
    {
        ...
        switch (t)
        {
            ...
            case 7:
            case 12:
                return NandaType.Bhadra;
            case 3:
            case 8:
            case 13:
                return NandaType.Jaya;
            case 4:
            case 9:
            case 14:
                return NandaType.Rikta;
            case 5:
            case 10:
                return NandaType.Purna;
        }
