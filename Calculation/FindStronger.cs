...
public class FindStronger
{
	...
	public Tables.Body.Name[] getOrderedGrahas()
	{
		Tables.Body.Name[] grahas =
		{
	...
	public Tables.Body.Name[] getOrderedGrahas(Tables.Body.Name[] grahas)
	{
		if (grahas.Length <= 1)
		{
			return grahas;
	...
	public Tables.Body.Name StrongerGraha(Tables.Body.Name m, Tables.Body.Name n, bool bSimpleLord)
	{
		var winner = 0;
		return StrongerGraha(m, n, bSimpleLord, ref winner);
	}

	public Tables.Body.Name StrongerGraha(Tables.Body.Name m, Tables.Body.Name n, bool bSimpleLord, ref int winner)
	{
	...
	public Tables.Body.Name WeakerGraha(Tables.Body.Name m, Tables.Body.Name n, bool bSimpleLord)
	{
	...
	public bool CmpGraha(Tables.Body.Name m, Tables.Body.Name n, bool bSimpleLord)
	{
		var winner = 0;
		return CmpGraha(m, n, bSimpleLord, ref winner);
	}

	public bool CmpGraha(Tables.Body.Name m, Tables.Body.Name n, bool bSimpleLord, ref int winner)
	{
		var bRet   = false;
		var bFound = true;
		winner = 0;
