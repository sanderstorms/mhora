...
public class FindStronger
{
    ...
    public Body.Body.Name[] getOrderedGrahas()
    {
    ...
    public Body.Body.Name[] getOrderedGrahas(Body.Body.Name[] grahas)
    {
        if (grahas.Length <= 1)
        {
            return grahas;
    ...
    public Body.Body.Name StrongerGraha(Body.Body.Name m, Body.Body.Name n, bool bSimpleLord)
    {
        var winner = 0;
        return StrongerGraha(m, n, bSimpleLord, ref winner);
    }

    public Body.Body.Name StrongerGraha(Body.Body.Name m, Body.Body.Name n, bool bSimpleLord, ref int winner)
    {
    ...
    public Body.Body.Name WeakerGraha(Body.Body.Name m, Body.Body.Name n, bool bSimpleLord)
    {
    ...
    public bool CmpGraha(Body.Body.Name m, Body.Body.Name n, bool bSimpleLord)
    {
        var winner = 0;
        return CmpGraha(m, n, bSimpleLord, ref winner);
    }

    public bool CmpGraha(Body.Body.Name m, Body.Body.Name n, bool bSimpleLord, ref int winner)
    {
        var bRet   = false;
        var bFound = true;
        winner = 0;
