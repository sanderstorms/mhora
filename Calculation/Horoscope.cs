...
namespace Mhora.Calculation
{
    ...
    public class Horoscope : ICloneable
    {
        ...
        public ArrayList CalculateGrahaArudhaDivisionPositions(Division dtype)
        {
            ...
            {
                al.Add(CalculateGrahaArudhaDivisionPosition((Body.Body.Name)parameters[i][1],
        ...
        private DivisionPosition CalculateArudhaDivisionPosition(ZodiacHouse   zh,
                                                                 Body.Body.Name     bn,
                                                                 Body.Body.Name     aname,
                                                                 Division      d,
                                                                 BodyType.Name btype)
        {
        ...
        public Body.Body.Name calculateKala(ref int iBase)
        {
            ...
            if (options.KalaType == HoroscopeOptions.EHoraType.Lmt)
            {
                ...
                bday_birth =
                    info.tob.time > lmt_sunset ||
                    info.tob.time < lmt_sunrise;
            }
        ...
        private Body.Body.Name calculateUpagrahasStart()
        {
            ...
            {
                default:
                case Basics.Weekday.Sunday: return Body.Body.Name.Jupiter;
        ...
        private void calculateSunsUpagrahas()
        {
            ...
            var bpDhuma = new Position(this,
                                           Body.Body.Name.Dhuma,
                                           BodyType.Name.Upagraha,
                                           slon.add(133.0 + 20.0 / 60.0),
                                           0,
                                           0,
                                           0,
                                           0,
            ...
            var bpVyatipata = new Position(this,
                                               Body.Body.Name.Vyatipata,
                                               BodyType.Name.Upagraha,
                                               new Longitude(360.0).sub(bpDhuma.longitude),
                                               0,
                                               0,
                                               0,
                                               0,
            ...
            var bpParivesha = new Position(this,
                                               Body.Body.Name.Parivesha,
                                               BodyType.Name.Upagraha,
                                               bpVyatipata.longitude.add(180),
                                               0,
                                               0,
                                               0,
                                               0,
            ...
            var bpIndrachapa = new Position(this,
                                                Body.Body.Name.Indrachapa,
                                                BodyType.Name.Upagraha,
                                                new Longitude(360.0).sub(bpParivesha.longitude),
                                                0,
                                                0,
                                                0,
                                                0,
            ...
            var bpUpaketu = new Position(this,
                                             Body.Body.Name.Upaketu,
                                             BodyType.Name.Upagraha,
                                             slon.sub(30),
                                             0,
                                             0,
        ...
        private void calculateSL()
        {
            ...
            var bp = new Position(this,
                                      Body.Body.Name.SreeLagna,
                                      BodyType.Name.SpecialLagna,
                                      slLon,
                                      0,
                                      0,
                                      0,
        ...
        public ArrayList calculateSahamas()
        {
            ...
            al.Add(sahamaHelper("Paradesa",
                                lon_base.add(9.0 * 30.0),
                                LordOfZodiacHouse(zh_lagna.add(9), new Division(Basics.DivisionType.Rasi)),
                                Body.Body.Name.Lagna));
            al.Add(sahamaHelper("Artha",
                                lon_base.add(2.0 * 30.0),
                                LordOfZodiacHouse(zh_lagna.add(2), new Division(Basics.DivisionType.Rasi)),
                                Body.Body.Name.Lagna));
            ...
            if (bDay)
            {
                al.Add(sahamaHelper("Karyasiddhi",
                                    Body.Body.Name.Saturn,
                                    Body.Body.Name.Sun,
                                    LordOfZodiacHouse(zh_sun, new Division(Basics.DivisionType.Rasi))));
            }
            else
            {
                al.Add(sahamaHelper("Karyasiddhi",
                                    Body.Body.Name.Saturn,
                                    Body.Body.Name.Moon,
                                    LordOfZodiacHouse(zh_moon, new Division(Basics.DivisionType.Rasi))));
            }
            ...
            al.Add(sahamaDNHelper("Preeti",
                                  ((Position)al[2]).longitude,
                                  ((Position)al[0]).longitude,
                                  Body.Body.Name.Lagna));
            ...
            al.Add(sahamaHelper("Labha",
                                lon_base.add(11.0 * 30.0),
                                LordOfZodiacHouse(zh_lagna.add(11), new Division(Basics.DivisionType.Rasi)),
                                Body.Body.Name.Lagna));
