...
public class ShadBalas
{
    ...
    public double drekkanaBala(Body.Body.Name b)
    {
        ...
        if (part == 1 && (b == Body.Body.Name.Sun || b == Body.Body.Name.Jupiter || b == Body.Body.Name.Mars))
        {
            return 15.0;
        }

        if (part == 2 && (b == Body.Body.Name.Saturn || b == Body.Body.Name.Mercury))
        {
            return 15.0;
        }

        if (part == 3 && (b == Body.Body.Name.Moon || b == Body.Body.Name.Venus))
        {
            return 15.0;
        }
    ...
    public double nathonnathaBala(Body.Body.Name b)
    {
        ...
        if (b == Body.Body.Name.Moon || b == Body.Body.Name.Mars || b == Body.Body.Name.Saturn)
        {
            diff = 60 - diff;
        }
    ...
    {
        verifyGraha(b);
        Body.Body.Name yearLord = Body.Body.Name.Sun, monthLord = Body.Body.Name.Sun;
