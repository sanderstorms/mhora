...
public class FindYogas
{
	...
	public FindYogas(Horoscope _h, Division __dtype)
	{
		h       = _h;
		_dtype  = __dtype;
		zhLagna = h.getPosition(Tables.Body.Name.Lagna).toDivisionPosition(_dtype).zodiac_house;
	}
	...
	public Tables.Body.Name stringToBody(string s)
	{
		switch (s)
		{
			case "su":
			...
			case "moo":
			case "moon":
				return Tables.Body.Name.Moon;
			case "ma":
			case "mar":
			case "mars":
				return Tables.Body.Name.Mars;
			case "me":
			case "mer":
			case "mercury":
				return Tables.Body.Name.Mercury;
			case "ju":
			case "jup":
			case "jupiter":
			...
			case "ven":
			case "venus":
				return Tables.Body.Name.Venus;
			case "sa":
			case "sat":
			case "saturn":
				return Tables.Body.Name.Saturn;
			case "ra":
			case "rah":
			case "rahu":
				return Tables.Body.Name.Rahu;
			case "ke":
			case "ket":
			case "ketu":
				return Tables.Body.Name.Ketu;
			case "la":
			case "lag":
			case "lagna":
			case "asc":
