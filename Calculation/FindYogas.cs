	...
	*/
    ...
    public class FindYogas
    {
        ...
        public Body.Body.Name stringToBody(string s)
        {
            ...
            {
                case "su":
                case "sun": return Body.Body.Name.Sun;
                case "mo":
                case "moo":
                case "moon": return Body.Body.Name.Moon;
                case "ma":
                case "mar":
                case "mars": return Body.Body.Name.Mars;
                case "me":
                case "mer":
                case "mercury": return Body.Body.Name.Mercury;
                case "ju":
                case "jup":
                case "jupiter": return Body.Body.Name.Jupiter;
                case "ve":
                case "ven":
                case "venus": return Body.Body.Name.Venus;
                case "sa":
                case "sat":
                case "saturn": return Body.Body.Name.Saturn;
                case "ra":
                case "rah":
                case "rahu": return Body.Body.Name.Rahu;
                case "ke":
                case "ket":
                case "ketu": return Body.Body.Name.Ketu;
                case "la":
                case "lag":
                case "lagna":
                case "asc": return Body.Body.Name.Lagna;
                default:
        ...
        public string replaceBasicNodeTermHelper(Division d, string cat, string val)
        {
            ...
            switch (cat)
            {
                ...
                case "rasiof:":
                    b = stringToBody(val);
                    return h.getPosition(b)
                            .toDivisionPosition(d)
                            .zodiac_house.value
                            .ToString()
                            .ToLower();
                case "lordof:":
                ...
                case "dispof:":
                    b = stringToBody(val);
                    return h.LordOfZodiacHouse(h.getPosition(b).toDivisionPosition(d).zodiac_house, d)
                            .ToString()
                            .ToLower();
            }
