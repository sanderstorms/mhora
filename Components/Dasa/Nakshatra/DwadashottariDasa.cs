...
public class DwadashottariDasa : NakshatraDasa, INakshatraDasa
{
	...
	public double lengthOfDasa(Elements.Body.Name plt)
	{
		switch (plt)
		{
			case Elements.Body.Name.Sun:     return 7;
			case Elements.Body.Name.Jupiter: return 9;
			case Elements.Body.Name.Ketu:    return 11;
			case Elements.Body.Name.Mercury: return 13;
			case Elements.Body.Name.Rahu:    return 15;
			case Elements.Body.Name.Mars:    return 17;
			case Elements.Body.Name.Saturn:  return 19;
			case Elements.Body.Name.Moon:    return 21;
		}
	...
	private Elements.Body.Name nextDasaLordHelper(Elements.Body.Name b)
	{
		switch (b)
		{
			...
			case Elements.Body.Name.Jupiter: return Elements.Body.Name.Ketu;
			case Elements.Body.Name.Ketu:    return Elements.Body.Name.Mercury;
			case Elements.Body.Name.Mercury: return Elements.Body.Name.Rahu;
			case Elements.Body.Name.Rahu:    return Elements.Body.Name.Mars;
			case Elements.Body.Name.Mars:    return Elements.Body.Name.Saturn;
			case Elements.Body.Name.Saturn:  return Elements.Body.Name.Moon;
