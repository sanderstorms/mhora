...
public class ShatabdikaDasa : NakshatraDasa, INakshatraDasa
{
	...
	public double lengthOfDasa(Elements.Body.Name plt)
	{
		switch (plt)
		{
			case Elements.Body.Name.Sun:     return 5;
			case Elements.Body.Name.Moon:    return 5;
			case Elements.Body.Name.Venus:   return 10;
			case Elements.Body.Name.Mercury: return 10;
			case Elements.Body.Name.Jupiter: return 20;
			case Elements.Body.Name.Mars:    return 20;
			case Elements.Body.Name.Saturn:  return 30;
		}
	...
	public Elements.Body.Name lordOfNakshatra(Elements.Nakshatra n)
	{
		...
		var diff_val = Basics.normalize_inc((int) Elements.Nakshatra.Name.Aswini, (int) Elements.Nakshatra.Name.Revati, nak_val - rev_val);
	...
	private Elements.Body.Name nextDasaLordHelper(Elements.Body.Name b)
	{
		switch (b)
		{
			...
			case Elements.Body.Name.Moon:    return Elements.Body.Name.Venus;
			case Elements.Body.Name.Venus:   return Elements.Body.Name.Mercury;
