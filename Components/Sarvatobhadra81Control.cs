...
#region Designer generated code
        ...
        {
            var f = new Font(MhoraGlobalOptions.Instance.GeneralFont.FontFamily,
                             MhoraGlobalOptions.Instance.GeneralFont.SizeInPoints - 2);
        ...
        {
            var f_sounds = new Font(MhoraGlobalOptions.Instance.GeneralFont.FontFamily,
                                    MhoraGlobalOptions.Instance.GeneralFont.SizeInPoints - 2);
            var f_sanskrit = new Font("Sanskrit 99",
