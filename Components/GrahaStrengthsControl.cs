...
#region Designer generated code
        ...
        private void InitializeComboBoxes()
        {
            ...
            {
                var s = Body.Body.toString((Body.Body.Name)i);
                cbGraha1.Items.Add(s);
                cbGraha2.Items.Add(s);
            }

            cbGraha1.SelectedIndex = (int)Body.Body.Name.Mars;
            cbGraha2.SelectedIndex = (int)Body.Body.Name.Ketu;
        ...
        private void Compute()
        {
            ...
            var winner = 0;
            var b1     = (Body.Body.Name)cbGraha1.SelectedIndex;
            var b2     = (Body.Body.Name)cbGraha2.SelectedIndex;
            ...
            for (var i = 0; i < al.Count; i++)
            {
                ...
                if (winner == 0)
                {
                    li.SubItems.Add(Body.Body.toString(bw));
                }
        ...
        private void cbStrength_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbStrength.SelectedIndex == RVimsottariDasa)
            {
                ...
                cbGraha1.SelectedIndex = (int)Body.Body.Name.Lagna;
                cbGraha1.SelectedIndex = (int)Body.Body.Name.Moon;
            }
        ...
        private void cbGraha1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbStrength.SelectedIndex == RCoLord)
            {
                ...
                {
                    case (int)Body.Body.Name.Mars:
                        cbGraha2.SelectedIndex = (int)Body.Body.Name.Ketu;
                        break;
                    case (int)Body.Body.Name.Ketu:
                        cbGraha2.SelectedIndex = (int)Body.Body.Name.Mars;
                        break;
                    case (int)Body.Body.Name.Saturn:
                        cbGraha2.SelectedIndex = (int)Body.Body.Name.Rahu;
                        break;
                    case (int)Body.Body.Name.Rahu:
                        cbGraha2.SelectedIndex = (int)Body.Body.Name.Saturn;
                        break;
                }
            }
