...
public static class Basics
{
	...
	public static Position CalculateSingleBodyPosition(double ut, int ipl, Body.Name body, Body.Type type, Horoscope h)
	{
	...
	public static ArrayList CalculateBodyPositions(Horoscope h, double sunrise)
	{
		...
		std_grahas.Add(CalculateSingleBodyPosition(julday_ut, sweph.SE_SUN, Body.Name.Sun, Body.Type.Graha, h));
		std_grahas.Add(CalculateSingleBodyPosition(julday_ut, sweph.SE_MOON, Body.Name.Moon, Body.Type.Graha, h));
		std_grahas.Add(CalculateSingleBodyPosition(julday_ut, sweph.SE_MARS, Body.Name.Mars, Body.Type.Graha, h));
		std_grahas.Add(CalculateSingleBodyPosition(julday_ut, sweph.SE_MERCURY, Body.Name.Mercury, Body.Type.Graha, h));
		std_grahas.Add(CalculateSingleBodyPosition(julday_ut, sweph.SE_JUPITER, Body.Name.Jupiter, Body.Type.Graha, h));
		std_grahas.Add(CalculateSingleBodyPosition(julday_ut, sweph.SE_VENUS, Body.Name.Venus, Body.Type.Graha, h));
		std_grahas.Add(CalculateSingleBodyPosition(julday_ut, sweph.SE_SATURN, Body.Name.Saturn, Body.Type.Graha, h));
		var rahu = CalculateSingleBodyPosition(julday_ut, swephRahuBody, Body.Name.Rahu, Body.Type.Graha, h);

		var ketu = CalculateSingleBodyPosition(julday_ut, swephRahuBody, Body.Name.Ketu, Body.Type.Graha, h);
		ketu.longitude = rahu.longitude.add(new Longitude(180.0));
		std_grahas.Add(rahu);
		std_grahas.Add(ketu);

		var asc = sweph.Lagna(julday_ut);
		std_grahas.Add(new Position(h, Body.Name.Lagna, Body.Type.Lagna, new Longitude(asc), 0, 0, 0, 0, 0));
		...
		std_grahas.Add(new Position(h, Body.Name.BhavaLagna, Body.Type.SpecialLagna, bl_lon, 0, 0, 0, 0, 0));
		std_grahas.Add(new Position(h, Body.Name.HoraLagna, Body.Type.SpecialLagna, hl_lon, 0, 0, 0, 0, 0));
		std_grahas.Add(new Position(h, Body.Name.GhatiLagna, Body.Type.SpecialLagna, gl_lon, 0, 0, 0, 0, 0));
		std_grahas.Add(new Position(h, Body.Name.VighatiLagna, Body.Type.SpecialLagna, vl_lon, 0, 0, 0, 0, 0));
