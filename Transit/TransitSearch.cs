...
#region Designer generated code
    ...
    {
        if (opts.SearchBody != Body.Body.Name.Sun && opts.SearchBody != Body.Body.Name.Moon) // &&
    ...
    {
        if ((int) opts.SearchBody <= (int) Body.Body.Name.Moon || (int) opts.SearchBody > (int) Body.Body.Name.Saturn)
        {
            DirectProgression();
            return;
        }
    ...
    {
        if (opts.SearchBody == Body.Body.Name.Sun || opts.SearchBody == Body.Body.Name.Moon || opts.SearchBody == Body.Body.Name.Lagna)
        {
            if (opts.Forward)
            {
