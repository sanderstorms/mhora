...
#region Designer generated code
        ...
        public void OnRecalculate(object o)
        {
            ...
            var l1 = h.getPosition(Body.Body.Name.Lagna);
            var l2 = h2.getPosition(Body.Body.Name.Lagna);
            var m1 = h.getPosition(Body.Body.Name.Moon);
            var m2 = h2.getPosition(Body.Body.Name.Moon);
            ...
            }
            {
                ...
                var ja        = h.getPosition(Body.Body.Name.Moon).toDivisionPosition(dtype).zodiac_house;
                var ch        = h2.getPosition(Body.Body.Name.Moon).toDivisionPosition(dtype).zodiac_house;
            ...
            }
            {
                ...
                var ja        = h.getPosition(Body.Body.Name.Moon).toDivisionPosition(dtype).zodiac_house;
                var ltithi    = h2.getPosition(Body.Body.Name.Moon).longitude.sub(h2.getPosition(Body.Body.Name.Sun).longitude);
            ...
            }
            {
                ...
                var ja        = h.getPosition(Body.Body.Name.Moon).toDivisionPosition(dtype).zodiac_house;
                var na        = h2.getPosition(Body.Body.Name.Moon).longitude.toNakshatra();
            ...
            }
            {
                ...
                var ja        = h.getPosition(Body.Body.Name.Moon).toDivisionPosition(dtype).zodiac_house;
                var sa        = h2.getPosition(Body.Body.Name.Lagna).toDivisionPosition(dtype).zodiac_house;
            ...
            }
            {
                ...
                var ja        = h.getPosition(Body.Body.Name.Moon).toDivisionPosition(dtype).zodiac_house;
                var op        = h2.getPosition(Body.Body.Name.Lagna).toDivisionPosition(dtype).zodiac_house;
