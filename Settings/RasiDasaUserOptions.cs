...
namespace mhora.Settings
{
    public class RasiDasaUserOptions : ICloneable
    {
        ...
        protected Body.Body.Name             mCoLordAqu;
        protected Body.Body.Name             mCoLordSco;
        ...
        {
            get =>
                mDtype.MultipleDivisions[0].Varga;
            set =>
                mDtype = new Division(value);
        }
        ...
        public Body.Body.Name ColordAqu
        {
            get =>
                mCoLordAqu;
            set =>
        ...
        public Body.Body.Name ColordSco
        {
            get =>
                mCoLordSco;
            set =>
        ...
        {
            mSeed      = h.getPosition(Body.Body.Name.Lagna).toDivisionPosition(Division).zodiac_house.value;
            mSeedHouse = 1;
        }
        ...
        public void calculateCoLords()
        {
            ...
            mCoLordAqu = fs.StrongerGraha(Body.Body.Name.Saturn, Body.Body.Name.Rahu, true);
            mCoLordSco = fs.StrongerGraha(Body.Body.Name.Mars, Body.Body.Name.Ketu, true);
        }
        ...
        public void calculateExceptions()
        {
            ...
            var zhKetu = h.getPosition(Body.Body.Name.Ketu).toDivisionPosition(Division).zodiac_house.value;
            var zhSat  = h.getPosition(Body.Body.Name.Saturn).toDivisionPosition(Division).zodiac_house.value;
            ...
            else
            {
                ...
                var b  = fs.StrongerGraha(Body.Body.Name.Saturn, Body.Body.Name.Ketu, false);
                if (b == Body.Body.Name.Ketu)
                {
                    mKetuExceptions.houses.Add(zhKetu);
                }
                else
