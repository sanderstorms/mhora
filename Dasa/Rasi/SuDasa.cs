...
namespace mhora
{
    public class SuDasa : Dasa, IDasa
    {
        ...
        public ArrayList Dasa(int cycle)
        {
            ...
            var bp_sl   = h.getPosition(Body.Body.Name.SreeLagna);
            ...
            var offset_length = bp_sl.longitude.toZodiacHouseOffset() /
                                30.0 *
        ...
        public ArrayList AntarDasa(DasaEntry pdi)
        {
            ...
            for (var i = 1; i <= 12; i++)
            {
                ...
                var di = new DasaEntry(zh_dasa.value,
                                       dasa_length_sum,
                                       dasa_length,
                                       pdi.level     + 1,
                                       pdi.shortDesc + " " + zh_dasa.value);
                al.Add(di);
                dasa_length_sum += dasa_length;
            }
        ...
        private Body.Body.Name GetLord(ZodiacHouse zh)
        {
            switch (zh.value)
            {
