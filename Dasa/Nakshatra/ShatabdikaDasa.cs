...
public class ShatabdikaDasa : NakshatraDasa, INakshatraDasa
{
	...
	public double lengthOfDasa(Tables.Body.Name plt)
	{
		switch (plt)
		{
			case Tables.Body.Name.Sun:     return 5;
			case Tables.Body.Name.Moon:    return 5;
			case Tables.Body.Name.Venus:   return 10;
			case Tables.Body.Name.Mercury: return 10;
			case Tables.Body.Name.Jupiter: return 20;
			case Tables.Body.Name.Mars:    return 20;
			case Tables.Body.Name.Saturn:  return 30;
		}
	...
	private Tables.Body.Name nextDasaLordHelper(Tables.Body.Name b)
	{
		switch (b)
		{
			...
			case Tables.Body.Name.Moon:    return Tables.Body.Name.Venus;
			case Tables.Body.Name.Venus:   return Tables.Body.Name.Mercury;
