...
public class DwisaptatiSamaDasa : NakshatraDasa, INakshatraDasa
{
	...
	public double lengthOfDasa(Tables.Body.Name plt)
	{
		switch (plt)
		{
			case Tables.Body.Name.Sun:     return 9;
			case Tables.Body.Name.Moon:    return 9;
			case Tables.Body.Name.Mars:    return 9;
			case Tables.Body.Name.Mercury: return 9;
			case Tables.Body.Name.Jupiter: return 9;
			case Tables.Body.Name.Venus:   return 9;
			case Tables.Body.Name.Saturn:  return 9;
			case Tables.Body.Name.Rahu:    return 9;
		}
	...
	private Tables.Body.Name nextDasaLordHelper(Tables.Body.Name b)
	{
		switch (b)
		{
			...
			case Tables.Body.Name.Saturn:  return Tables.Body.Name.Rahu;
			case Tables.Body.Name.Rahu:    return Tables.Body.Name.Sun;
		}
