...
public class PanchottariDasa : NakshatraDasa, INakshatraDasa
{
    ...
    public double lengthOfDasa(Body.Body.Name plt)
    {
        switch (plt)
        {
            ...
            case Body.Body.Name.Mars:    return 15;
            case Body.Body.Name.Venus:   return 16;
            case Body.Body.Name.Moon:    return 17;
    ...
    private Body.Body.Name nextDasaLordHelper(Body.Body.Name b)
    {
        switch (b)
        {
            case Body.Body.Name.Sun:     return Body.Body.Name.Mercury;
            case Body.Body.Name.Mercury: return Body.Body.Name.Saturn;
            case Body.Body.Name.Saturn:  return Body.Body.Name.Mars;
            case Body.Body.Name.Mars:    return Body.Body.Name.Venus;
            case Body.Body.Name.Venus:   return Body.Body.Name.Moon;
            case Body.Body.Name.Moon:    return Body.Body.Name.Jupiter;
            case Body.Body.Name.Jupiter: return Body.Body.Name.Sun;
        }
