...
namespace Mhora
{
    ...
    {
        private static readonly ToolTip tooltip_event = new ToolTip();
        ...
        private void SetDescriptionLabel()
        {
            ...
            dasaInfo.Text = string.Format("{0} {1:0.00} {2}",
                                          dasaInfo.Text,
                                          DasaOptions.YearLength,
                                          DasaOptions.YearType);
...
#region Component Designer generated code
        ...
        {
            if (DasaOptions.YearType   == ToDate.DateType.TithiYear &&
        ...
        {
            if (DasaOptions.YearType   == ToDate.DateType.SolarYear &&
                DasaOptions.YearLength == 360.0)
            {
                return;
            }
        ...
        private void mLocateEvent_Click(object sender, EventArgs e)
        {
            if (mEventOptionsCache == null)
            {
                ...
                mEventOptionsCache = new EventUserOptions(new Moment(dtNow.Year,
                                                                     dtNow.Month,
                                                                     dtNow.Day,
