...
namespace Mhora.Yoga
{
	public static class Aakriti
	{
		...
		public static bool AakritiArdhachandra(this Grahas grahaList)
		{
		...
		public static bool AakritiChakra(this Grahas grahaList)
		{
		...
		public static bool AakritiChhatra(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiDanda(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiDhanush(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiGada(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiHalaMoksha(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
			foreach (var graha in grahas)
			{
		...
		//One born in this yoga is gluttonous, servile, blessed with friends, liked by good people, living by agriculture.
		public static bool AakritiHalaKama(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
			foreach (var graha in grahas)
			{
		...
		//One born in this yoga is gluttonous, servile, blessed with friends, liked by good people, living by agriculture.
		public static bool AakritiHalaArtha(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
			foreach (var graha in grahas)
			{
		...
		public static bool AakritiKoota(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiNauka(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiPakshi(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiSamudra(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiShakata(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiShakti(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiShara(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiShringataka(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiVaapi(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiVajra(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiYava(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
		...
		public static bool AakritiYoopa(this Grahas grahaList)
		{
			var grahas = grahaList.Planets;
