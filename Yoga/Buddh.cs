...
namespace Mhora.Yoga
{
	public static class Buddh
	{
		...
		public static bool BuddhGuru(this Grahas grahas)
		{
		...
		public static bool BuddhGuru10(this Grahas grahas)
		{
		...
		public static bool BuddhGuru7(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
		...
		public static bool BuddhGuru9(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
		...
		public static bool BuddhGuru4(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
		...
		public static bool BuddhMangal(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BuddhMangal1(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BuddhMangal10(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BuddhMangal7(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BuddhMangal4(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BuddhShani(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BuddhShani1(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool BuddhShani7(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.JayaBhava)
			{
		...
		public static bool BuddhShani10(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.KarmaBhava)
			{
		...
		public static bool BuddhShani9(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.DharmaBhava)
			{
		...
		public static bool BuddhShukra(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BuddhShukra1(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool BuddhShukra7(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool BuddhShukra9(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool BuddhShukra10(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool Buddha(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
			if (jupiter.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool BuddhGuruShani(this Grahas grahas) => (BuddhShani(grahas) && BuddhGuru(grahas));

		//Conjunction between Mercury, Jupiter, Venus, and Saturn.
		//Very learned, of remarkable memory, truthful, amiable, sensuous.
		public static bool BuddhGuruShaniShukra(this Grahas grahas) => (BuddhGuruShani(grahas) && BuddhShukra(grahas));
		...
		public static bool BuddhMangalGuru(this Grahas grahas) => BuddhMangal(grahas) && BuddhGuru(grahas);
		...
		public static bool BuddhMangalShani(this Grahas grahas) => BuddhMangal(grahas) && BuddhShani(grahas);

		//Conjunction between Mercury, Venus, and Jupiter.
		//Good in looks, bereft of enemies, truthful, of lasting fame.
		public static bool BuddhShukraGuru(this Grahas grahas) => BuddhShukra(grahas) && BuddhGuru(grahas);
		...
		public static bool BuddhShukraMangal(this Grahas grahas) => BuddhShukra(grahas) && BuddhMangal(grahas);

		//Conjunction between Mercury, Venus, and Saturn.
		//The person is untruthful, vicious, addicted to women not his own, a wanderer.
		public static bool BuddhShukraShani(this Grahas grahas) => BuddhShukra(grahas) && BuddhShani(grahas);
		...
		public static bool BudhaAditya(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
		...
		public static bool BudhaAditya1 (this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool BudhaAditya7(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
			if (mercury.Bhava != Bhava.JayaBhava)
			{
		...
		public static bool BudhaAditya9(this Grahas grahas)
		{
			var mercury = grahas[Body.Mercury];
