...
namespace Mhora.Yoga
{
	public static class Ravi
	{
		...
		public static bool UbhaychariYoga(this Grahas grahas, Body body1, Body body2)
		{
			byte yoga   = 0x00;
		...
		public static bool VeshiYoga(this Grahas grahas, Body body)
		{
		...
		public static bool VoshiYoga(this Grahas grahas, Body body)
		{
			var graha = grahas[body];
		...
		public static bool RaviUbhaychari1(this Grahas grahas) => grahas.UbhaychariYoga(Body.Mars, Body.Saturn);
		...
		public static bool RaviUbhaychari2(this Grahas grahas) => grahas.UbhaychariYoga(Body.Mercury, Body.Venus);
		...
		public static bool RaviUbhaychari3(this Grahas grahas) => grahas.UbhaychariYoga(Body.Mercury, Body.Jupiter);
		...
		public static bool RaviUbhaychari5(this Grahas grahas) => grahas.UbhaychariYoga(Body.Venus, Body.Saturn);
		...
		public static bool RaviUbhaychari6(this Grahas grahas) => grahas.UbhaychariYoga(Body.Venus, Body.Mars);
		...
		public static bool RaviUbhaychari7(this Grahas grahas) => grahas.UbhaychariYoga(Body.Jupiter, Body.Saturn);
		...
		public static bool RaviUbhaychari8(this Grahas grahas) => grahas.UbhaychariYoga(Body.Mercury, Body.Mars);
		...
		public static bool RaviUbhaychari9(this Grahas grahas) => grahas.UbhaychariYoga(Body.Mercury, Body.Jupiter);
		...
		public static bool RaviUbhaychari10(this Grahas grahas) => grahas.UbhaychariYoga(Body.Mercury, Body.Saturn);
		...
		public static bool RaviUbhaychari11(this Grahas grahas) => grahas.UbhaychariYoga(Body.Venus, Body.Jupiter);

		//Of a steady nature, truthful, wise, undaunted in battle.
		public static bool RaviVeshi1 (this Grahas grahas) => grahas.VeshiYoga(Body.Jupiter);

		//Valorous in battle, a charioteer, renowned.
		public static bool RaviVeshi2(this Grahas grahas) => grahas.VeshiYoga(Body.Mars);
			
		//Renowned, Respectable, with many virtues, intrepid.
		public static bool RaviVeshi3(this Grahas grahas) => grahas.VeshiYoga(Body.Venus);

		//Sweet tongued, handsome, capable of befooling others.
		public static bool RaviVeshi4(this Grahas grahas) => grahas.VeshiYoga(Body.Mercury);

		//Interested in Business, inclined to cheat others of their wealth, with malice towards his preceptors.	
		public static bool RaviVeshi5(this Grahas grahas) => grahas.VeshiYoga(Body.Saturn);

		//Hostile to mother, doing good to other’s.
		public static bool RaviVoshi1 (this Grahas grahas) => grahas.VoshiYoga(Body.Mars);

		//A hoarder, illustrious like the sunlit day.
		public static bool RaviVoshi2 (this Grahas grahas) => grahas.VoshiYoga(Body.Jupiter);

		//To all appearance poor, devoid of physical strength, shameless
		public static bool RaviVoshi3 (this Grahas grahas) => grahas.VoshiYoga(Body.Mercury);

		//Addicted to women of other’s, kind- hearted, exhausted, of mature looks
		public static bool RaviVoshi4 (this Grahas grahas) => grahas.VoshiYoga(Body.Saturn);

		//Cowardly, lustful, without enthusiasm, servile.
		public static bool RaviVoshi5 (this Grahas grahas) => grahas.VoshiYoga(Body.Venus);
	}
}
