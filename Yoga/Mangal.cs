...
namespace Mhora.Yoga
{
	public static class Mangal
	{
		...
		public static bool MangalGuru(this Grahas grahas)
		{
		...
		public static bool MangalGuru1(this Grahas grahas)
		{
			if (grahas.MangalGuru () == false)
			{
				return (false);
			}

			if (grahas[Body.Mars].Bhava != Bhava.LagnaBhava)
			{
				return (true);
			}
		...
		public static bool MangalGuru4(this Grahas grahas)
		{
			if (grahas.MangalGuru () == false)
			{
				return (false);
		...
		public static bool MangalGuru7(this Grahas grahas)
		{
			if (grahas.MangalGuru () == false)
			{
				return (false);
		...
		public static bool MangalGuru9(this Grahas grahas)
		{
			if (grahas.MangalGuru() == false)
			{
				return (false);
			...
			if (grahas[Body.Mars].Bhava != Bhava.DharmaBhava)
			{
				return (true);
			}
		...
		public static bool MangalGuru10(this Grahas grahas)
		{
			if (grahas.MangalGuru() == false)
			{
				return (false);
		...
		public static bool MangalShani(this Grahas grahas)
		{
			var mars = grahas[Body.Mars];
		...
		public static bool MangalShani1(this Grahas grahas)
		{
			if (grahas.MangalShani() == false)
			{
				return (false);
			}
			if (grahas[Body.Mars].Bhava != Bhava.LagnaBhava)
		...
		public static bool MangalShani4(this Grahas grahas)
		{
			if (grahas.MangalShani() == false)
			{
				return (false);
		...
		public static bool MangalShani7(this Grahas grahas)
		{
			if (grahas.MangalShani() == false)
			{
				return (false);
		...
		public static bool MangalShani9(this Grahas grahas)
		{
			if (grahas.MangalShani() == false)
			{
				return (false);
		...
		public static bool MangalShani10(this Grahas grahas)
		{
			if (grahas.MangalShani() == false)
			{
				return (false);
		...
		public static bool MangalBuddhGuruShani(this Grahas grahas)
		{
			var mars = grahas[Body.Mars];
		...
		public static bool MangalBuddhGuruShukra(this Grahas grahas)
		{
			var mars = grahas[Body.Mars];
			if (mars.IsConjuctWith(Body.Mercury) == false)
			{
		...
		public static bool MangalBuddhGuruShukraShani(this Grahas grahas)
		{
			if (grahas.MangalBuddhGuruShukra() == false)
			{
				return (false);
			}

			return grahas.MangalShani();
		}

		//Conjunction between Mars, Mercury, Venus, and Saturn.
		//Skilled in battle, a wrestler, very healthy, renowned, keeps dogs as pets.
		public static bool MangalBuddhShukraShani(this Grahas grahas)
		{
			var mars = grahas[Body.Mars];
			if (mars.IsConjuctWith(Body.Mercury) == false)
			{
		...
		public static bool MangalGuruShani(this Grahas grahas)
		{
			var mars = grahas[Body.Mars];
			if (mars.IsConjuctWith(Body.Mercury) == false)
			{
		...
		public static bool MangalGuruShukraShani(this Grahas grahas)
		{
			var mars = grahas[Body.Mars];
			if (mars.IsConjuctWith(Body.Jupiter) == false)
			{
