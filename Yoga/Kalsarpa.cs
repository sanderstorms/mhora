...
namespace Mhora.Yoga
{
	...
	{
		public static bool KalsarpaYoga(this Grahas grahas)
		{
		...
		public static bool AnantKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		public static bool KanktokKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		//This type of a person will become a Scientist, Detective, Geologist or a Tantrik. But he will be wicked in nature
		public static bool KulikKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		public static bool MahapadmKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		public static bool PadmaKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		public static bool PatakKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		public static bool ShankhchudKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		public static bool ShankhpatKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
			if (rahu.Bhava != Bhava.KarmaBhava)
			{
		...
		//The person will become a Jyotishi or an Advocate, but he will have a dangerous disease.
		public static bool SheshnagKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		public static bool TakshakKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
		...
		//But these type of people are having some mental troubles, and there luck rises after the death of there father.
		public static bool VasukiKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
			if (rahu.Bhava != Bhava.DharmaBhava)
			{
		...
		//This person will get child after some troubles and will have obstacles in education as well,
		//will earn in shares or lottries. Earns name in the field of art.
		public static bool VishaktaKalsarpa(this Grahas grahas)
		{
			var rahu = grahas[Body.Rahu];
			if (rahu.Bhava != Bhava.PutraBhava)
			{
