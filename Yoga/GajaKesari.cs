...
namespace Mhora.Yoga
{
	...
	{
		public static bool GajaKesariChandra(this Grahas grahas)
		{
		...
		public static bool GajaKesariChandra1(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
			if (jupiter.IsConjuctWith(Body.Moon))
			{
		...
		public static bool GajaKesariChandra4(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
			if (jupiter.IsConjuctWith(Body.Moon))
			{
		...
		public static bool GajaKesariChandra7(this Grahas grahas)
		{
		...
		public static bool GajaKesariChandra9(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
			if (jupiter.IsConjuctWith(Body.Moon))
			{
		...
		public static bool GajaKesariChandra10(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
			if (jupiter.IsConjuctWith(Body.Moon))
			{
		...
		public static bool GajaKesari7Chandra(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
		...
		public static bool GajaKesari10Chandra(this Grahas grahas)
		{
			var jupiter = grahas[Body.Jupiter];
			var moon    = grahas[Body.Moon];
