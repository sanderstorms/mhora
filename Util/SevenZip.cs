...
namespace Mhora.Util
{
    ...
    {
        const string exe7ZipPath = @"C:\Program Files\7-Zip\7z.exe";
        ...
        static Task<int> RunProcessAsync(string fileName, string arguments, ProcessWindowStyle windowStyle = ProcessWindowStyle.Hidden)
        {
