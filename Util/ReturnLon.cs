...
namespace Mhora
{
    ...
    internal class CuspTransitSearch
    {
        ...
        public double TransitSearchDirect(Body.Body.Name SearchBody,
                                          Moment    StartDate,
                                          bool      Forward,
                                          Longitude TransitPoint,
                                          Longitude FoundLon,
                                          ref bool  bForward)
        {
            var bDiscard = true;
        ...
        public double TransitSearch(Body.Body.Name SearchBody,
                                    Moment    StartDate,
                                    bool      Forward,
                                    Longitude TransitPoint,
                                    Longitude FoundLon,
                                    ref bool  bForward)
        {
            if (SearchBody == Body.Body.Name.Sun ||
                SearchBody == Body.Body.Name.Moon)
            {
                return TransitSearchDirect(SearchBody,
                                           StartDate,
                                           Forward,
                                           TransitPoint,
                                           FoundLon,
            ...
            if (((int)SearchBody <= (int)Body.Body.Name.Moon ||
                 (int)SearchBody > (int)Body.Body.Name.Saturn) &&
                SearchBody != Body.Body.Name.Lagna)
            {
