...
public static class Dll
{
    ...
    /// <summary>
    ///     Decrements the reference count of the loaded dynamic-link library (DLL). When the reference count reaches zero, the
    ...
    public static bool LoadUnmanagedModule(string module)
    {
        ...
        var fileExistAndLoaded = fileExist && !IntPtr.Zero.Equals(LoadLibrary(fullPath));
