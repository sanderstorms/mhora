...
public class ShatTrimshaSamaDasa : NakshatraDasa, INakshatraDasa
{
	...
	public Body.Name lordOfNakshatra(Elements.Nakshatra n)
	{
		...
		var shr_val  = (int) Elements.Nakshatra.Name.Sravana;
		var diff_val = Basics.normalize_inc((int) Elements.Nakshatra.Name.Aswini, (int) Elements.Nakshatra.Name.Revati, nak_val - shr_val);
