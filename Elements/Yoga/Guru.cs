...
namespace Mhora.Elements.GuruShani
{
	public static class Guru
	{
		...
		public static bool GuruShani(this DivisionType varga)
		{
		...
		public static bool GuruShani1(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GuruShani4(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GuruShani7(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GuruShani9(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GuruShani10(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GuruShukra(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GuruShukra1(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			if (jupiter.Bhava != Bhava.LagnaBhava)
			{
		...
		public static bool GuruShukra4(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			if (jupiter.Bhava != Bhava.SukhaBhava)
			{
		...
		public static bool GuruShukra7(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			if (jupiter.Bhava != Bhava.JayaBhava)
			{
		...
		public static bool GuruShukra9(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GuruShukra10(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			if (jupiter.Bhava != Bhava.KarmaBhava)
			{
