...
namespace Mhora.Elements.Yoga
{
	public static class Mahapurusha
	{
		...
		public static bool MahapurushaBhadraBuddh(this DivisionType varga)
		{
		...
		public static bool MahapurushaHamsa (this DivisionType varga)
		{
		...
		public static bool MahapurushaMalavya (this DivisionType varga)
		{
		...
		public static bool MahapurushaRuchaka (this DivisionType varga)
		{
		...
		public static bool MahapurushaSasha (this DivisionType varga)
		{
			var saturn = Graha.Find(Body.Mars, varga);
