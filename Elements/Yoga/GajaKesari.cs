...
namespace Mhora.Elements.Yoga
{
	public static class GajaKesari
	{
		...
		public static bool GajaKesariChandra1(this DivisionType varga)
		{
		...
		public static bool GajaKesariChandra4(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			if (jupiter.IsConjuctWith(Body.Moon))
			{
		...
		public static bool GajaKesariChandra7(this DivisionType varga)
		{
		...
		public static bool GajaKesariChandra9(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			if (jupiter.IsConjuctWith(Body.Moon))
			{
		...
		public static bool GajaKesariChandra10(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			if (jupiter.IsConjuctWith(Body.Moon))
			{
		...
		public static bool GajaKesari7Chandra(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
		...
		public static bool GajaKesari10Chandra(this DivisionType varga)
		{
			var jupiter = Graha.Find(Body.Jupiter, varga);
			var moon    = Graha.Find(Body.Moon, varga);
