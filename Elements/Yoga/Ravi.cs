...
namespace Mhora.Elements.Yoga
{
	public static class Ravi
	{
		...
		public static bool UbhaychariYoga(this DivisionType varga, Body body1, Body body2)
		{
			byte yoga   = 0x00;
		...
		public static bool VeshiYoga(this DivisionType varga, Body body)
		{
		...
		public static bool VoshiYoga(this DivisionType varga, Body body)
		{
			var graha = Graha.Find(body, varga);
		...
		public static bool RaviUbhaychari1(this DivisionType varga) => varga.UbhaychariYoga(Body.Mars, Body.Saturn);
		...
		public static bool RaviUbhaychari2(this DivisionType varga) => varga.UbhaychariYoga(Body.Mercury, Body.Venus);
		...
		public static bool RaviUbhaychari3(this DivisionType varga) => varga.UbhaychariYoga(Body.Mercury, Body.Jupiter);
		...
		public static bool RaviUbhaychari5(this DivisionType varga) => varga.UbhaychariYoga(Body.Venus, Body.Saturn);
		...
		public static bool RaviUbhaychari6(this DivisionType varga) => varga.UbhaychariYoga(Body.Venus, Body.Mars);
		...
		public static bool RaviUbhaychari7(this DivisionType varga) => varga.UbhaychariYoga(Body.Jupiter, Body.Saturn);
		...
		public static bool RaviUbhaychari8(this DivisionType varga) => varga.UbhaychariYoga(Body.Mercury, Body.Mars);
		...
		public static bool RaviUbhaychari9(this DivisionType varga) => varga.UbhaychariYoga(Body.Mercury, Body.Jupiter);
		...
		public static bool RaviUbhaychari10(this DivisionType varga) => varga.UbhaychariYoga(Body.Mercury, Body.Saturn);
		...
		public static bool RaviUbhaychari11(this DivisionType varga) => varga.UbhaychariYoga(Body.Venus, Body.Jupiter);

		//Of a steady nature, truthful, wise, undaunted in battle.
		public static bool RaviVeshi1 (this DivisionType varga) => VeshiYoga(varga, Body.Jupiter);

		//Valorous in battle, a charioteer, renowned.
		public static bool RaviVeshi2(this DivisionType varga) => VeshiYoga(varga, Body.Mars);

		//Renowned, Respectable, with many virtues, intrepid.
		public static bool RaviVeshi3(this DivisionType varga) => VeshiYoga(varga, Body.Venus);

		//Sweet tongued, handsome, capable of befooling others.
		public static bool RaviVeshi4(this DivisionType varga) => VeshiYoga(varga, Body.Mercury);

		//Interested in Business, inclined to cheat others of their wealth, with malice towards his preceptors.	
		public static bool RaviVeshi5(this DivisionType varga) => VeshiYoga(varga, Body.Saturn);

		//Hostile to mother, doing good to other’s.
		public static bool RaviVoshi1 (this DivisionType varga) => VoshiYoga(varga, Body.Mars);

		//A hoarder, illustrious like the sunlit day.
		public static bool RaviVoshi2 (this DivisionType varga) => VoshiYoga(varga, Body.Jupiter);

		//To all appearance poor, devoid of physical strength, shameless
		public static bool RaviVoshi3 (this DivisionType varga) => VoshiYoga(varga, Body.Mercury);

		//Addicted to women of other’s, kind- hearted, exhausted, of mature looks
		public static bool RaviVoshi4 (this DivisionType varga) => VoshiYoga(varga, Body.Saturn);

		//Cowardly, lustful, without enthusiasm, servile.
		public static bool RaviVoshi5 (this DivisionType varga) => VoshiYoga(varga, Body.Venus);
	}
}
